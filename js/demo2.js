 ...
 */
{
	...
	const TiltObj = function(el, options) {
		...
		this.DOM = {};
		this.DOM.img = this.el.querySelector('.my-description');
		// this.DOM.title = this.el.querySelector('.mine-work-title');
		// this._initEvents();
	}

	TiltObj.prototype.options = {
		movement: {
			img : { translation : {x: 20, y: 20} },
			// title : { translation : {x: 20, y: 0} },
		}
	};
